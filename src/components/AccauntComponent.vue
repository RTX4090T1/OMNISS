    ...
    <div class="main-back-color min-vh-100 d-flex justify-content-center align-items-center">
      ...
      <div class="card p-5 rounded shadow-lg text-center" style="width: 480px; height: 850px; background-color: white;">
        ...
        <div class="profile-section mb-4">
          ...
          <p class="mt-3 text-muted">Change Picture</p>
        </div>
  
   
        <div class="user-info mb-5">
          <p class="fw-bold fs-4">{{ getUserName || 'Guest' }}</p>
          <p class="text-muted fw-bold fs-5">{{ getUserEmail || 'Not Logged In' }}</p>
        </div>
  

        <div class="list-group list-group-flush mb-4">
          <router-link class="list-group-item list-group-item-action text-center text-dark fs-5" to="/myAdds">
            <i class="bi bi-folder me-2"></i> My Applications
          </router-link>
          <router-link class="list-group-item list-group-item-action text-center text-dark fs-5" to="/ord">
            <i class="bi bi-cart me-2"></i> My Orders
          </router-link>
          <router-link class="list-group-item list-group-item-action text-center text-dark fs-5" to="/sale">
            <i class="bi bi-bar-chart me-2"></i> My Sales
          </router-link>
          <router-link class="list-group-item list-group-item-action text-center text-dark fs-5" to="/favorites">
            <i class="bi bi-bar-chart me-2"></i> Favorites
          </router-link>
        ...
        <router-link class="list-group-item list-group-item-action text-center text-dark fs-5 my-4" to="/">
            <i class="bi bi-bar-chart me-2"></i> Home
          </router-link>
      </div>
    </div>
  </template>
